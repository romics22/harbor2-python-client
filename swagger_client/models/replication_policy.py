...
class ReplicationPolicy(object):
    ...
    def __init__(self, id=None, name=None, description=None, src_registry=None, dest_registry=None, dest_namespace=None, dest_namespace_replace_count=None, trigger=None, filters=None, replicate_deletion=None, deletion=None, override=None, enabled=None, creation_time=None, update_time=None, speed=None, _configuration=None):  # noqa: E501
