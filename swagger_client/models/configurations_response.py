...
class ConfigurationsResponse(object):
    ...
    def __init__(self, auth_mode=None, email_from=None, email_host=None, email_identity=None, email_insecure=None, email_port=None, email_ssl=None, email_username=None, ldap_base_dn=None, ldap_filter=None, ldap_group_base_dn=None, ldap_group_admin_dn=None, ldap_group_attribute_name=None, ldap_group_search_filter=None, ldap_group_search_scope=None, ldap_scope=None, ldap_search_dn=None, ldap_timeout=None, ldap_uid=None, ldap_url=None, ldap_verify_cert=None, ldap_group_membership_attribute=None, project_creation_restriction=None, read_only=None, self_registration=None, token_expiration=None, uaa_client_id=None, uaa_client_secret=None, uaa_endpoint=None, uaa_verify_cert=None, http_authproxy_endpoint=None, http_authproxy_tokenreview_endpoint=None, http_authproxy_admin_groups=None, http_authproxy_admin_usernames=None, http_authproxy_verify_cert=None, http_authproxy_skip_search=None, http_authproxy_server_certificate=None, oidc_name=None, oidc_endpoint=None, oidc_client_id=None, oidc_groups_claim=None, oidc_admin_group=None, oidc_scope=None, oidc_user_claim=None, oidc_verify_cert=None, oidc_auto_onboard=None, oidc_extra_redirect_parms=None, robot_token_duration=None, robot_name_prefix=None, notification_enable=None, quota_per_project_enable=None, storage_per_project=None, scan_all_policy=None, _configuration=None):  # noqa: E501
